...
export default {
	...
	// text color
	color_text_base: '#333333', // base
	color_text_base_inverse: '#ffffff', // base_inverse
	...
	fill_body: '#FFFFFF', // page background
	...
	// border color
	border_color_base: '#F0F0F0',
	border_color_component: 'rgba(138, 140, 143, 0.35)',
